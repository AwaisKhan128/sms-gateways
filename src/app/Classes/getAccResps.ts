export class getAccResp
{
    http_code:string|any;
    response_code:string|any;
    response_msg:string|any;


}

export class getAccResp1
{
    user_id:any;
    username:any;
    user_email:any;
